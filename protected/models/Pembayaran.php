...
class Pembayaran extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_pasien, id_tindakan, id_obat', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_pembayaran, id_pasien, id_tindakan, id_obat', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'tindakan' => array(self::HAS_ONE, 'Tindakan', 'id_tindakan'),
